...
const TESTIMONIALS = [
  {
    ...
    avatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAn1XO8OxfDSF0xHceYU0zA9zvAW8v0ysJS68eC35p3s84_HjDPjYGQvVJp0_r3HNW8Jm5Liyy6xPM28z66z9Y02PPLrz2N78B4t5INJ5ob8TlLL75MoIg4V_6h1EWTJgrPIFK-c3RMhT-L37lbg4PGh67KeSUWoIHj1c5DmxDAfXJFFCT_9PvXBx7ohY1B1MTtAJUXU8xxKL28nwF1SpjCOfcJpekT9JvimeHmaNVOLJvf8dFKBpwMqw",
    rating: 5,
  },
  {
    id: "2",
    ...
    avatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDDkX6hQ8VfV94GzBzC5NRfHd9rY7K5jLm9cW5b9sH6gZ8kLmNpQrS7tU6vW5xY4zZ3aA2bB1cC2dD3eE4fF5gG6hH7iI8jJ9kK0lL1mM2nN3oO4pP5qQ6rR7sS8tT9uU",
    rating: 5,
  },
  {
    id: "3",
  ...
  const onScroll = (event: any) => {
    const index = Math.round(
      event.nativeEvent.contentOffset.x /
        (width - spacing.lg * 2 - spacing.md + spacing.sm * 2),
    );
    ...
    <ScreenWrapper>
      ...
      >
        ...
        <View style={[styles.heroSection, { marginBottom: spacing.xl }]}>
          ...
          >
            در ایکس‌الوتور، ما می‌دانیم که نگهداری آسانسور فقط یک سرویس
            نیست—بلکه یک الزام حیاتی برای ایمنی است. ما تحت مجوزهای رسمی دولتی
            فعالیت می‌کنیم و بیمه مسئولیت جامع را برای محافظت از هر مسافر حفظ
            می‌کنیم.
          </AppText>
        </View>
        ...
        <View style={[styles.section, { marginBottom: spacing.xl }]}>
          ...
          >
            ...
            >
              هر آسانسور تحت سرویس ایکس‌الوتور توسط بیمه جامع حوادث مسافران
              پشتیبانی می‌شود. ما پوشش کامل مسئولیت داریم و آرامش خاطر کامل را
              برای مالکان و مدیران ساختمان فراهم می‌کنیم.
            </AppText>
            ...
            {TESTIMONIALS.map((_, index) => (
              <View
                ...
                style={{
                  ...
                  borderRadius: 4,
                  backgroundColor:
                    currentIndex === index ? colors.secondary : colors.border,
                }}
              />
            ))}
          </View>
      ...
      >
        ...
        >
          <Ionicons name="call-outline" size={22} color={colors.onPrimary} />
          <AppText
            variant="button"
            style={{
